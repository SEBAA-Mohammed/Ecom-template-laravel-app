                                    ...
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            <a href="#" class="link-to-product">
                                                <img src="{{ $produit->image }}" alt="dd" width="270"
                                        ...
                                        <div class="info">
                                            ...
                                            <h4 class="product-title"><a href="#"
                                                    class="pr-name">{{ $produit->designation }}</a></h4>
                                            <div class="price">
                    ...
                    <div class="biolife-panigations-block">
                        <ul class="panigation-contain">
                            @if ($produits->onFirstPage())
                                <li><span class="link-page disabled"><i class="fa fa-angle-left"
                                            aria-hidden="true"></i></span></li>
                            @else
                                <li><a href="{{ $produits->previousPageUrl() }}" class="link-page"><i
                            ...
                            @else
                                <li><span class="link-page disabled"><i class="fa fa-angle-right"
                                            aria-hidden="true"></i></span></li>
                            @endif
                        </ul>
                    </div>
