        ...
        <div class="container">
            ...
            <div class="top-bar right">
                <ul class="social-list">
                    ...
                    <li><a href="https://www.facebook.com/share/WT7Exq79uhoqkBJM/?mibextid=qi2Omg" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="wrap-menu">
                            <ul class="menu clone-main-menu">
                                ...
                                <li class="menu-item menu-item-has-children has-megamenu">
                                    <a href="#" class="menu-name" data-title="{{ $famille->libelle }}"><i class="biolife-icon icon-fruits"></i>{{ $famille->libelle }}</a>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-md-4 col-sm-12 xs-margin-bottom-25 md-margin-bottom-0">
                                                    <div class="wrap-custom-menu vertical-menu">
                                                        <ul class="menu">
                                                            ...
                                                            <li><a href="#">{{ $sousFamille->libelle }}</a>
                                                            </li>
                                                            @endforeach
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 col-md-4 col-sm-12 lg-padding-left-50 xs-margin-bottom-25 md-margin-bottom-0">
                                                    <div class="biolife-products-block max-width-270">
                                                        <img src="{{ $famille->image }}" width="161" height="136" alt="organic">
                                ...
                                @else
                                <li class="menu-item"><a href="#" class="menu-title"><i class="biolife-icon icon-fresh-juice"></i>{{ $famille->libelle }}</a>
                                </li>
                                @endif
                                @endforeach
                ...
                <div class="col-lg-9 col-md-8 padding-top-2px">
                    ...
                    <div class="live-info">
                        <p class="telephone"><i class="fa fa-phone" aria-hidden="true"></i><b class="phone-number">(+212) 762 416 046</b></p>
